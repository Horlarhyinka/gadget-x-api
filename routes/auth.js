...
const {usePassport, usePassportAuth} = require("../config/passport")
...
router.get("/redirect", catchAsync(usePassportAuth), catchAsync(passportRedirect))
router.get("/logout", catchAsync(authenticate), catchAsync(logout))
