...
passport.use(new Strategy({
    ...
    callbackURL:"http://localhost:2003/api/v1/auth/redirect"
...
const usePassportRedirect = passport.authenticate("google")

module.exports = { passport,usePassport,usePassportRedirect}